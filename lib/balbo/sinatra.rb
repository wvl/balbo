...
module Balbo
  module TiltTemplate
    def compile!
      @engine = Balbo::Template.new(data).compile
    end
...
Tilt.register 'balbo', Balbo::TiltTemplate
...
#       def balbo(template, options={}, locals={})
#         render :balbo, template, options, locals
#       end
# 
#       # This is called by Sinatra's `render` with the proper paths
#       # and, potentially, a block containing a sub-view
#       def render_balbo(template, data, opts, locals, &block)
...
#         Balbo::Template.load(data, ::Sinatra::Base.views).render
#       end
#     end
# 
#     def self.registered(app)
#       app.helpers Balbo::Sinatra::Helpers
...
# end
# 
# Sinatra.register Balbo::Sinatra
